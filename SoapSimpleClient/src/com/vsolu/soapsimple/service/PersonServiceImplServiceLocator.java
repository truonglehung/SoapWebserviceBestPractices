...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.vsolu.soapsimple.service.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SoapSimple/services/PersonServiceImpl";
    ...
    public com.vsolu.soapsimple.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vsolu.soapsimple.service.PersonServiceImplSoapBindingStub _stub = new com.vsolu.soapsimple.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vsolu.soapsimple.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vsolu.soapsimple.service.PersonServiceImplSoapBindingStub _stub = new com.vsolu.soapsimple.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.soapsimple.vsolu.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.soapsimple.vsolu.com", "PersonServiceImpl"));
        }
